...
df_k = pd.read_excel('archivos/Cinemark - 28-08-2022.xlsx')
df_po = pd.read_excel('archivos/cinepolis - 28-08-2022.xlsx')
df_ms = pd.read_excel('archivos/cinemas - 28-08-2022.xlsx')
...
df_dic.to_excel("dic_nombreCine.xlsx", index=False)
#print(df_dic)